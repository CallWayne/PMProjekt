...
class BacklogItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create backlog_item" do
    assert_difference('BacklogItem.count') do
      post backlog_items_url, params: { backlog_item: { descripton: @backlog_item.descripton, ranking: @backlog_item.ranking } }
    end
  ...
  test "should update backlog_item" do
    patch backlog_item_url(@backlog_item), params: { backlog_item: { descripton: @backlog_item.descripton, ranking: @backlog_item.ranking } }
